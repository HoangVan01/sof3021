  ...
  <table class="table">
		...
		<tbody>
			...
			<tr>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<form method="POST"
																action="/sof3021_assignment/admin/products/update/${ pro.id }"
																>
																<div>
																	<label>Name</label>
																	<input name="name" class="form-control" value = "${pro.name }"/>
																</div>
																<div>
																	<label>Image</label>
																	<input name="image" 
																		class="form-control" value = "${pro.image }" />
																</div>
																<div>
																	<label>Price</label>
																...
																<div>
																	...
																	<input name="createdDate" class="form-control" type="date"
																		value = "${pro.createdDate }" />
																</div>
																	<div>
																	<label>Available</label>
																	<input name="available" class="form-control"
																		value = "${pro.available}" />
																</div>
				...
				<td>
					<a href="/sof3021_assignment/admin/products/delete/${ pro.id }">
						Delete
					</a>
					</a>
						<a href="/sof3021_assignment/admin/products/create">
						Create
					</a>
				</td>
			</tr>
	...
	<div>
		<ul class="pagination">
			<li class="page-item">
				<a class="page-link" href="/sof3021_assignment/admin/products/index">
					First page
				</a>
			</li>
			<li class="page-item">
				<a class="page-link" href="/sof3021_assignment/admin/products/index?page=${ data.number - 1 }">
					Previos page
				</a>
			</li>
			<li class="page-item">
			...
			<li class="page-item">
				<a class="page-link" href="/sof3021_assignment/admin/products/index?page=${ data.totalPages - 1 }">
					Last page
				</a>
			</li>
		</ul>
