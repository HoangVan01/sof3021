  ...
  <table class="table">
		...
		<tbody>
			<c:forEach items="${ data.content }" var="cate">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header bg-info">
									<h5 class="modal-title text-white" id="staticBackdropLabel">Update
										a account</h5>
								...
								<div class="modal-body">
									<form method="GET"
										action="/sof3021_assignment/admin/categories/update/${ cate.id }">
										<div>
											<label>Name</label> <input name="name" class="form-control"
												value="${cate.name }" />
										</div>
										<button class="btn btn-primary w-100 mt-3" id="liveToastBtn">Update</button>
				...
				<td><a
					href="/sof3021_assignment/admin/categories/delete/${ cate.id }">
						Delete </a>
						</a>
						<a href="/sof3021_assignment/admin/categories/create">
						Create
					</a></td>
					</tr>
			</c:forEach>
	...
	<div>
		<ul class="pagination">
			<li class="page-item"><a class="page-link"
				href="/sof3021_assignment/admin/categories/index"> First page </a></li>
			<li class="page-item"><a class="page-link"
				href="/sof3021_assignment/admin/categories/index?page=${ data.number - 1 }">
					Previos page </a></li>
			<li class="page-item"><a class="page-link"
				href="/sof3021_assignment/admin/categories/index?page=${ data.number + 1 }">
					Next page </a></li>
			<li class="page-item"><a class="page-link"
				href="/sof3021_assignment/admin/categories/index?page=${ data.totalPages - 1 }">
					Last page </a></li>
		</ul>
	</div>
